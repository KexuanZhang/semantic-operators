...
# Initialize the LLM 
# llm = LLM(model=model_path, enable_chunked_prefill=True, max_num_batched_tokens=2048)
# llm = LLM(model=model_path)

llm = LLM(
    model="meta-llama/Llama-2-7b-hf",  # or any other HF model repo
...
def llm_inference(prompt):
    ...
    # print(f"Memory before inference: {memory_before:.2f} MB")
